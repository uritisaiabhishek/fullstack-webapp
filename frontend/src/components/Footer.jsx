import data from '../data/site-info.json';
            ...
            <div className="flex flex-wrap md:text-left text-center order-first">
              <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                ...
                <nav className="list-none mb-10">
                  ...
                  <li>
                    <a className="text-gray-600 hover:text-gray-800">Cookie policies</a>
                  </li>
                  <li>
              ...
              <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                ...
                <p className="text-gray-500 text-sm mt-2 md:text-left text-center">we do not share your personal information with anyone</p>
              </div>
            </div>
          </div>
          <div className="bg-gray-100">
            <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
              <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                ...
                <span className="ml-3 text-xl">{data.siteName}</span>
              </a>
              <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© {currentYear} {data.siteName} —
                <a href="https://www.linkedin.com/in/uritisaiabhishek/" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@uritisaiabhishek</a>
              </p>
              <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                {
                  data.socialLinks.map((link, index) => (
                    <a key={index} className="text-gray-500" href={link.url} target="_blank" rel="noopener noreferrer">
